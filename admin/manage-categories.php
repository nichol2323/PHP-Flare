...
if (isset($_SESSION['id']) && isset($_SESSION['name']) && isset($_SESSION['positionid'])) {
    ...
    if ($_GET['action'] == 'del' && $_GET['rid']) {
        ...
        $msg = "Category successfully move to archive";
    }
?>
    <!DOCTYPE html>
    <html lang="en">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a data-toggle="tooltip" data-placement="top" title="Edit this category" href="edit-category.php?cid=<?php echo htmlentities($row['id']); ?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a>&nbsp;
                                                            <a data-toggle="tooltip" data-placement="top" title="Move to archive" href="manage-categories.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del"><i class="fa fa-archive" style="color: #f05050"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                } ?>
