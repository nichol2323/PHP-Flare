...
if (isset($_SESSION['id']) && isset($_SESSION['name']) && isset($_SESSION['positionid'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into tblcategory(CategoryName,Description,Is_Active, PostingDate) values('$category','$description','$status', '$today')");
        if ($query) {
                                        ...
                                        <div class="col-md-12">
                                            <form class="form-horizontal" name="category" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" value="" name="category" autocomplete="off" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
